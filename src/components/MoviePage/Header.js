import {CardMedia, Container, Fab, Grid, makeStyles, Tooltip, Typography,} from "@material-ui/core";
...
const Header = ({details, created_by}) => {
    ...
    const {watchlist, isLoading, isAdding, isRemoving} = useSelector((state) => state.watchlist);
                        ...
                        >
                            ...
                            {(details.media_type === "movie" ||
                                ...
                                <Grid item="true" className={classes.wrapper}>
                                    ...
                                    <Tooltip
                                        title={isAuth ? isAdded ? "Remove from your watchlist" : "Add to your watchlist" : "Login to add this movie to your watchlist"}>
                                        <Fab
                                            size="medium"
                                            color="primary"
                                            className={classes.button}
                                            onClick={
                                                !isAuth ? () => alert("You need to login to add this movie to your watchlis") :
                                                    !isAdded ? () => handleAddMovie() : () => alert("Removed")
                                            }
                                        >
                                            <BookmarkIcon/>
                                        </Fab>
